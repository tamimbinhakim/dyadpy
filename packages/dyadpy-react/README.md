...
`@dyadpy/react` adds hook leaves on top of your generated `client.ts`:
...
import { api, _routes } from "./client"; // generated by `dyadpy dev`
...
import { createReactClient } from "@dyadpy/react";
import { createApi, _routes } from "./client";
